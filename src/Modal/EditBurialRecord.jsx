...
const EditBurialRecord = (props) => {
    ...
    const handleInputChange = (event) => {
        ...
        const handleSubmit = (e) => {
            ...
            const response = fetch('https://7o71cponk0.execute-api.us-west-1.amazonaws.com/data/update', {
              method: 'PUT',
              headers: {
        ...
        <Modal show={props.show} onHide={props.handleClose} backdrop="static">
            ...
            <Modal.Body>
                <form className="AddBurialForm" onSubmit={handleSubmit}>
                    ...
                    <input type="date" value={(dateofexcavation).toISOString().substr(0, 10)} name="dateofexcavation" id='dateofexcavation'  onChange={handleInputChange}/>
                    <br></br>
                    <br></br>
